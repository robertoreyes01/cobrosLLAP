        ...
        @if (Auth::user()?->id_rol == 3)
            <div class="card w-72 mt-20">
                ...
                <section class="flex justify-center">
                    <button class="rounded-sm p-1.75 bg-[#751711] hover:bg-[#5c120e] text-white font-semibold transition-colors duration-200 cursor-pointer shadow-md"
                    onclick="window.location.href='{{ route('payments.student') }}'">
                        Accede
                    </button>
                </section>
            </div>
