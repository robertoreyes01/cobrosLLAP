        ...
        @if (Auth::user()?->id_rol == 3)
            <div class="card w-72 mt-20">
                ...
                <section class="flex justify-center">
                    <button onclick="window.location.href='{{ route('payments.student', $padre = Auth::user()->id_usuario) }}'"
        ...
        @elseif (Auth::user()?->id_rol == 2)
            <div class="grid grid-cols-2 grid-rows-2 gap-25">
                ...
                <div class="card w-72 mt-30">
                    ...
                    <section class="flex justify-center">
                        <button
                            class="rounded-sm p-1.75 bg-[#751711] hover:bg-[#5c120e] text-white font-semibold transition-colors duration-200 cursor-pointer shadow-md">Acceder</button>
                    </section>
                </div>
            </div>
